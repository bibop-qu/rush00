...
if ($product !== NULL)
{
	...
	if ($action == "modif" and $price)
	{
		$query = "UPDATE products SET image='$image' WHERE product='$product'";
		mysqli_query($conn, $query);
	}
	if ($action == "modif")
	{
	...
	else if ($action == "add" and $category != NULL and $description != NULL and $price != NULL and $quantity != NULL and $image != NULL)
	{
	...
	else if ($action == "dell" and $_POST['category'] != NULL and $_POST['product'] == NULL and $_POST['description'] == NULL and $_POST['price'] == NULL and $_POST['quantity'] == NULL and $_POST['image'] == NULL)
		{
	...
	else if ($action == "dell" and $_POST['category'] == NULL and $_POST['description'] == NULL and $_POST['price'] == NULL and $_POST['quantity'] == NULL and $_POST['image'] == NULL)
	{
