...
<?PHP
	...
	echo "<HR>";
	echo ('<form method="POST" action="modif_cart.php">product:  <input type="text" name ="product"><br/>category:  <INPUT type="text" name="category"><br/> description:  <input type="text" name="description"></br> price <input type="text" name ="price"><br/>quantity <input type="text" name ="quantity"><br/>couleur <input type="text" name ="couleur"><br/> <input type="submit" name="action_cart" value="modif"><input type="submit" name="action_cart" value="add"><input type="submit" name="action_cart" value="dell"></form>');
	echo "<HR>";
	mysqli_close($conn)
	?>
	</BODY>
